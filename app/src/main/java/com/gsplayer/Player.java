...
import com.gsplayer.common.MatchFilterVisitor;
import com.gsplayer.controller.BroadcastsHandler;
import com.gsplayer.controller.PhoneStateHandler;
import com.gsplayer.dirchooser.DirChooserConstants;
import com.gsplayer.model.Instance;
import com.gsplayer.model.Track;
import com.gsplayer.persistance.framework.db.ObservableDatabase;
...
import com.gsplayer.player.OutputUsingOnClickListener;
import com.gsplayer.playlist.Playlist;
import com.gsplayer.playlist.playorder.PlayOrderRandom;
import com.gsplayer.playlist.playorder.PlayOrderSorted;
import com.gsplayer.playlist.playorder.PlayOrderStrategy;
import com.gsplayer.preferences.AbstractKey;
import com.gsplayer.preferences.Keys;
import com.gsplayer.preferences.Preferences;
import com.gsplayer.preferences.PreferencesObserver;
import com.gsplayer.util.Shorty;
import com.gsplayer.view.AlbumArtView;
import com.gsplayer.view.FileChooser;
...
public class Player extends ListActivity
{
	...
	public static final String DIR_CHOOSER_ACTION = "com.gpss.gsplayer.player.DIR_CHOOSER";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.gpss.gsplayer.R.layout.main);
	...
	private void lookupViewElements(){
		...
		progressBar = (SeekBar) findViewById(com.gpss.gsplayer.R.id.progressBar);

		list = (ImageView) findViewById(com.gpss.gsplayer.R.id.listButton);
		logo = (ImageView) findViewById(com.gpss.gsplayer.R.id.logoButton);
		settings = (ImageView) findViewById(com.gpss.gsplayer.R.id.settingsButton);

		backButton = (ImageView) findViewById(com.gpss.gsplayer.R.id.backButton);
		playButton = (ImageView) findViewById(com.gpss.gsplayer.R.id.playButton);
		nextButton = (ImageView) findViewById(com.gpss.gsplayer.R.id.nextButton);

		shuffleButton = (ImageView) findViewById(com.gpss.gsplayer.R.id.shuffleButton);
		shuffleCheckBox = (CheckBox) findViewById(com.gpss.gsplayer.R.id.shuffleCheckBox);

		rescan = (ImageView) findViewById(com.gpss.gsplayer.R.id.rescan);
		mediaDir = (TextView) findViewById(com.gpss.gsplayer.R.id.mediaDir);
		rescanProgressBar = (ProgressBar) findViewById(com.gpss.gsplayer.R.id.rescanProgressBar);
		rescanProgressBarState = (LinearLayout) findViewById(com.gpss.gsplayer.R.id.rescanState);
		rescanProgressBarIndicatorAll = (TextView) findViewById(com.gpss.gsplayer.R.id.rescanProgressBarIndicatorAll);
		rescanProgressBarIndicatorState = (TextView) findViewById(com.gpss.gsplayer.R.id.rescanProgressBarIndicatorState);
		rescanProgressBarIndicatorTrack = (TextView) findViewById(com.gpss.gsplayer.R.id.rescanProgressBarIndicatorTrack);
		rescanTogglePause = (ImageView) findViewById(com.gpss.gsplayer.R.id.togglePause);
		chooseMediaDir = (ImageView) findViewById(com.gpss.gsplayer.R.id.chooseMediaDir);
	}
	...
	private void SetupButtons()
	{
		shuffleButton.setImageDrawable(
				  tp.playlist.preferences.get(Keys.SHUFFLE) ?
							 getResources().getDrawable(com.gpss.gsplayer.R.drawable.dice48_active) :
							 getResources().getDrawable(com.gpss.gsplayer.R.drawable.dice48)
		);
	...
	private void SetupObservers()
	{
		...
		tp.playlist.addObserver(new Playlist.PlaylistTrackChangeObserver()
		{
			public void startUpdatePlaylist()
			{
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescan.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.fs_scan_stop48));
			...
			public void startRescan(final int toProcess)
			{
				...
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescanTogglePause.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.fs_scan_pause48));
			...
			public void pauseRescan()
			{
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						rescanTogglePause.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.fs_scan_unpause48));
					}
				});
			}
			...
			public void endRescan()
			{
				...
				runOnUiThread(new Runnable()
				{
					public void run()
					{
						...
						rescan.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.fs_scan_start48));
					}
				});
			}
					...
					runOnUiThread(new Runnable()
					{
						public void run()
						{
							shuffleButton.setImageDrawable(getResources().getDrawable(
									  shuffle ? com.gpss.gsplayer.R.drawable.dice48_active : com.gpss.gsplayer.R.drawable.dice48));
		...
		tp.player.addObserver(new ObservableOutput.PlayerObserver()
		{
			...
			public void started()
			{
				playButton.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.pause96));
			}

			public void stopped()
			{
				playButton.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.play96));
			}
		...
		tp.db.addObserver(new ObservableDatabase.DbObserver()
		{
			...
			public void cleared()
			{
				Toast.makeText(getApplicationContext(), getString(com.gpss.gsplayer.R.string.toastRescan), Toast.LENGTH_LONG).show();
	...
	{
		nowPlayingSlide = (RelativeLayout) findViewById(com.gpss.gsplayer.R.id.now_playing_slide);
		playlistSlide = (RelativeLayout) findViewById(com.gpss.gsplayer.R.id.playlist_slide);
		settingsSlide = (RelativeLayout) findViewById(com.gpss.gsplayer.R.id.settings_slide);
	...
	{
		duration = (TextView) findViewById(com.gpss.gsplayer.R.id.trackDuration);
		currTrackPosition = (TextView) findViewById(com.gpss.gsplayer.R.id.trackCurrPostion);

		ResetHeaderButtons();
		logo.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.logo128_active));
	...
	private void SwitchToPlaylistSlide()
	{
		...
		list.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.list64_active));
	...
	private void SwitchToSettingsSlide()
	{
		...
		settings.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.settings48_active));
...
// ========================================= //
	...
	{
		list.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.list64));
		logo.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.logo128));
		settings.setImageDrawable(getResources().getDrawable(com.gpss.gsplayer.R.drawable.settings48));
	}
	...
	/**
	 * Async rescan, returns immediately, use {@link com.gsplayer.playlist.Playlist.PlaylistObserver} to receive changes
	 */
