...
public class PlayerService extends Service implements Output
{
   ...
   private MediaPlayer getMp(){
	...
	{
		Notification note = new Notification(com.gpss.gsplayer.R.drawable.play96, getText(com.gpss.gsplayer.R.string.app_name), System.currentTimeMillis());
		...
		note.setLatestEventInfo(this, getText(com.gpss.gsplayer.R.string.app_name),
