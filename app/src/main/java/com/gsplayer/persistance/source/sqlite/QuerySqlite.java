...
import com.gsplayer.persistance.framework.query.Query;
import com.gsplayer.persistance.framework.mapping.Mapping;
import com.gsplayer.persistance.framework.sort.FieldOrder;
import com.gsplayer.persistance.framework.sort.Order;
import com.gsplayer.persistance.framework.sort.OrderSet;
import com.gsplayer.persistance.framework.sort.RandomOrder;
import com.gsplayer.persistance.source.relational.FieldPersistable;
import com.gsplayer.persistance.source.sql.query.*;
import com.gsplayer.persistance.source.sql.query.Operator;
...
public class QuerySqlite<PROJECTION, TARGET, RESULT> extends Query<Select, WhereClause, OrderClause, RESULT, Cursor, TARGET, PROJECTION>
{
	...
	public WhereClause visit(NotFilter<? super PROJECTION> notFilter)
	{
		Filter<? super PROJECTION> inversedFilter = notFilter.getFilter().accept(new FilterVisitorGenerified<PROJECTION, RESULT,Object,Filter<? super PROJECTION>>()
		{
			...
			{
				final com.gsplayer.persistance.framework.filter.Operator inversedOp;
				switch (fieldFilter.getOperator())
				{
					case NEQ:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.EQ;
						break;
					case EQ:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.NEQ;
						break;
					case GE:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.LT;
						break;
					case GT:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.LE;
						break;
					case LE:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.GT;
						break;
					case LIKE:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.NOT_LIKE;
						break;
					case NOT_LIKE:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.LIKE;
						break;
					case LT:
						inversedOp = com.gsplayer.persistance.framework.filter.Operator.GE;
						break;
					default:
