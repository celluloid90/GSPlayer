package com.gsplayer.controller;
...
public abstract class TouchHandler extends Playlist.PlaylistFilterChangeObserver implements View.OnTouchListener, ObservableOutput.PlayerObserver
{
	...
	private enum BowMenuEntry
	{
		LEFT(){
										  ...
										  boolean visible)
			{
				...
				activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_left).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_left_icon).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_left).setVisibility(visibility);
			}

			@Override
			public View getView(Activity activity)
			{
				return activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_left);
			}

			@Override
			public void adapt(Track track, Activity activity)
			{
				((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_left)).setText(track.getAlbumName());
			}
				...
				filter.accept(new FilterVisitor<Tables.Tracks, Boolean>()
				{
					public <T, Z> Boolean visit(FieldFilter<? super Tables.Tracks, Z, T> fieldFilter)
					{
						if(Tables.AlbumsReadable.ALBUM.equals(fieldFilter.getField()))
						{
							...
							ImageView bow = (ImageView) activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_left);
							bow.setImageResource(activated ? com.gpss.gsplayer.R.drawable.menubow_left_290_active : com.gpss.gsplayer.R.drawable.menubow_left_290);
							if(activated)
							{
					...
					public Boolean visit(NotFilter<? super Tables.Tracks> notFilter)
					{
						if(notFilter.getFilter().accept(this)){
							((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_left)).setTextColor(Color.RED);
							return activated;
						}
						return false;
					}
		...
		RIGHT{
			...
			{
				int visibility = visible ? View.VISIBLE : View.GONE;
				activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_right).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_right_icon).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_right).setVisibility(visibility);
			}

			@Override
			public View getView(Activity activity)
			{
				return activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_right);
			}

			@Override
			public void adapt(Track track, Activity activity)
			{
				((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_right)).setText(track.getArtistName());
			}
			...
			public void adapt(final Filter<? super Tables.Tracks> filter, final Track track, final boolean activated, final Activity activity)
			{
				filter.accept(new FilterVisitor<Tables.Tracks, Boolean>()
				{
					public <T, Z> Boolean visit(FieldFilter<? super Tables.Tracks, Z, T> fieldFilter)
					{
						...
						{
							setSettedFilter(activated ? filter : null);
							ImageView bow = (ImageView) activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_right);
							bow.setImageResource(activated ? com.gpss.gsplayer.R.drawable.menubow_right_290_active : com.gpss.gsplayer.R.drawable.menubow_right_290);
							if(activated)
							{
								adapt(track, activity);
							}
					...
					{
						if(notFilter.getFilter().accept(this)){
							((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_right)).setTextColor(Color.RED);
							return activated;
						}
						return false;
					}
		...
		TOPLINE{
			...
			{
				int visibility = visible ? View.VISIBLE : View.GONE;
				activity.findViewById(com.gpss.gsplayer.R.id.linearLayoutDir).setVisibility(visibility);
			}

			@Override
			public View getView(Activity activity)
			{
				return activity.findViewById(com.gpss.gsplayer.R.id.linearLayoutDir);
			}

			@Override
			public void adapt(Track track, Activity activity)
			{
				((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_topline)).setText(track.getPath());
			}
			...
			public void adapt(final Filter<? super Tables.Tracks> filter, final Track track, final boolean activated, final Activity activity)
			{
				filter.accept(new TurtleFilterVisitor<Tables.Tracks, Boolean>()
				{
					...
					{
						if(notFilter.getFilter().accept(this)){
							((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_topline)).setTextColor(Color.RED);
							return activated;
						}
						return false;
					}
					...
					{
						activity.findViewById(com.gpss.gsplayer.R.id.dir_filter_border).setBackgroundColor(activated ? Color.argb(177, 21, 164, 0) : Color.argb(177, 152, 152, 152));
						((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_topline)).setText(dirFilter.getValue().replaceAll("%", "*"));
						setSettedFilter(activated ? filter : null);
						if(!activated)
						{
							adapt(track, activity);
		...
		TOP{
			...
			{
				int visibility = visible ? View.VISIBLE : View.GONE;
				activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_top).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_top_icon).setVisibility(visibility);
				activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_top).setVisibility(visibility);
			}

			@Override
			public View getView(Activity activity)
			{
				return activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_top);
			}

			@Override
			public void adapt(Track track, Activity activity)
			{
				((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_top)).setText(track.getGenreName());
			}
			...
			public void adapt(final Filter<? super Tables.Tracks> filter, final Track track, final boolean activated, final Activity activity)
			{
				filter.accept(new FilterVisitor<Tables.Tracks, Boolean>()
				{
					public <T, Z> Boolean visit(FieldFilter<? super Tables.Tracks, Z, T> fieldFilter)
					{
						...
						{
							setSettedFilter(activated ? filter : null);
							ImageView bow = (ImageView) activity.findViewById(com.gpss.gsplayer.R.id.bowmenu_top);
							bow.setImageResource(activated ? com.gpss.gsplayer.R.drawable.menubow_top_290_active : com.gpss.gsplayer.R.drawable.menubow_top_290);
							if(activated)
							{
								adapt(track, activity);
							}
					...
					{
						if(notFilter.getFilter().accept(this)){
							((TextView)activity.findViewById(com.gpss.gsplayer.R.id.track_instant_filter_top)).setTextColor(Color.RED);
							return activated;
						}
						return false;
					}
	...
	protected TouchHandler(final Activity activity, View... scrollingViews)
	{
		...
		pointer = (ImageView) activity.findViewById(com.gpss.gsplayer.R.id.pointer);
