...
public class DirChooser extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.gpss.gsplayer.R.layout.dir_chooser);
	...
	private void init()
	{
		dirList = (ListView) findViewById(com.gpss.gsplayer.R.id.dirList);
		currDirLabel = (TextView) findViewById(com.gpss.gsplayer.R.id.currDirLabel);
		upButton = (ImageView) findViewById(com.gpss.gsplayer.R.id.up);
		chooseDir = (ImageView) findViewById(com.gpss.gsplayer.R.id.choose_dir);
