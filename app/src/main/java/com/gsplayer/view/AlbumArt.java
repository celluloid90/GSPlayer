...
import com.gsplayer.presentation.AlbumArtResolver;
...
public class AlbumArt
{
	public enum Type
	{
		RIGHT(-1, com.gpss.gsplayer.R.id.albumArtRight), // FIXME: should be 1, if your know why its inverted, change it
		LEFT(1, com.gpss.gsplayer.R.id.albumArtLeft), // FIXME: should be -1, your know why its inverted, change it
		CENTER(0, com.gpss.gsplayer.R.id.albumArt);
						 ...
						 TurtleDatabase db)
	{
		...
		albumArt = (ImageView) albumArtView.findViewById(com.gpss.gsplayer.R.id.picture);
		title = (TextView) albumArtView.findViewById(com.gpss.gsplayer.R.id.trackTitle);
		artist = (TextView) albumArtView.findViewById(com.gpss.gsplayer.R.id.trackArtist);
		album = (TextView) albumArtView.findViewById(com.gpss.gsplayer.R.id.trackAlbum);
	...
	public void setTrackDigest(final Track track)
	{
		...
		albumArt.setImageDrawable(albumArtView.getResources().getDrawable(com.gpss.gsplayer.R.drawable.blank_album_art));
